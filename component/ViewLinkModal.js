              ...
              {link.googleLink && (
                <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Google Reviews</p>
                      <p className="text-sm text-gray-600 truncate max-w-xs">{link.googleLink}</p>
                    </div>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between p-3 bg-pink-50 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 truncate max-w-xs">{link.instagramLink}</p>
                    </div>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{link.whatsappNumber}</p>
                    </div>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 truncate max-w-xs">{link.portfolioLink}</p>
                    </div>
                  </div>
                  <button
              ...
              {link.customLinkTitle && link.customLink && (
                <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">{link.customLinkTitle}</p>
                      <p className="text-sm text-gray-600 truncate max-w-xs">{link.customLink}</p>
                    </div>
                  </div>
                  <button
